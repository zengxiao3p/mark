...
scrapy_link = 'http://www.qingbank.cn/list/new'
...
class ToScrapeCSSSpider(scrapy.Spider):
    ...
    name = "nsyh_original_bank_xptj"
    allowed_domains = ["www.qingbank.cn"]
    start_urls = [
        scrapy_link,
    ]
    custom_settings = {
        'ITEM_PIPELINES': {'nongshangyinhang.pipelines.NsyhOriginalBankXptjPipeline': 301}
    }
    ...
    def parse(self, response):
        ...
        if currentpage < pagesize:
            ...
            next_page_url = domain + '/list/new-' + str(nextpage)
