...
scrapy_link = 'http://www.abchina.com/cn/PersonalServices/ABCPromotion/guangdong/default.htm'
...
class ToScrapeCSSSpider(scrapy.Spider):
    ...
    name = "nyyh_original_bank_yhhd_gd"
    allowed_domains = [domain]
    start_urls = [
        scrapy_link,
    ]
    custom_settings = {
        'ITEM_PIPELINES': {'nongyeyinhang.pipelines.NongyeyinhangYhhdGdPipeline': 302}
    }
        ...
        try:
            ...
            for showcss in response.css('div.details_rightWrapC>ul>li'):
                ...
                if (showcss.css('span>a::attr("href")').extract_first().startswith('http') == False):
                    item[
                        'goto_link'] = "http://www.abchina.com/cn/PersonalServices/ABCPromotion/guangdong/" + showcss.css(
                ...
                if currentpage == 1:
                    ...
                    item[
                        'scrapy_link'] = "http://www.abchina.com/cn/PersonalServices/ABCPromotion/guangdong/default_" + str(
                        currentpage) + ".htm"
                yield item

            if currentpage < pagesize:
                nextpage = int(currentpage) + 1
                next_page_url = "http://www.abchina.com/cn/PersonalServices/ABCPromotion/guangdong/default_" + str(
                    nextpage - 1) + ".htm"
